...
export class ObjectRisksComponent implements AfterViewInit {
  ...
  data;
  displayedColumns: string[] = ['id', 'objectType', 'riskId', 'required'];
  filteredValues: any = { id: "", objectType: "", riskId: "" };
